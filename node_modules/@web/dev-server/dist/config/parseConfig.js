...
async function parseConfig(config, cliArgs) {
    var _a;
    const mergedConfigs = (0, mergeConfigs_1.mergeConfigs)(defaultConfig, config, cliArgs);
    ...
    if (finalConfig.nodeResolve) {
        ...
        finalConfig.plugins.push((0, nodeResolvePlugin_1.nodeResolvePlugin)(finalConfig.rootDir, finalConfig.preserveSymlinks, userOptions));
    }
    // map flags to plugin
    if (finalConfig === null || finalConfig === void 0 ? void 0 : finalConfig.esbuildTarget) {
        finalConfig.plugins.unshift((0, esbuildPlugin_1.esbuildPlugin)(finalConfig.esbuildTarget));
    }
    if (finalConfig.watch) {
        finalConfig.plugins.unshift((0, watchPlugin_1.watchPlugin)());
    }
    return finalConfig;
}
