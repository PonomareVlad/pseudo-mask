...
async function startDevServer(options = {}) {
    ...
    try {
        ...
        const config = await (0, parseConfig_1.parseConfig)(mergedConfig, cliArgs);
        const { logger, loggerPlugin } = (0, createLogger_1.createLogger)({
        ...
        if (config.open != null && config.open !== false) {
            await (0, openBrowser_1.openBrowser)(config);
        }
        return server;
    }
    catch (error) {
